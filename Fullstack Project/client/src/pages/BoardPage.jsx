...
import { Link, useNavigate } from 'react-router-dom'; // 1. useNavigate එකතු කරන ලදී
...
export default function BoardPage() {
  const navigate = useNavigate(); // useNavigate hook එක initialize කරන ලදී
  ...
  // 2. NotFoundPage එකට Navigate වන පරිදි handleTestError පමණක් වෙනස් කරන ලදී
  ...
  if (status === 'error') return <ErrorState message={error} onRetry={loadBoardData} />;
